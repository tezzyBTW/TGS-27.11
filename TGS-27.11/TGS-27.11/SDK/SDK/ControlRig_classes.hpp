...
public:
	...
	uint8                                         Pad_258[0xF0];                                     // 0x0258(0x00F0)(Fixing Size After Last Property [ Dumper-8 ])
	class URigHierarchy*                          HierarchyForCacheValidation;                       // 0x0348(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_350[0xB0];                                     // 0x0350(0x00B0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	void ResetToDefault();
	TArray<struct FRigElementKey> RestoreConnectorsFromInfos(const TArray<struct FRigConnectorInfo>& InInfos, bool bSetupUndoRedo);
	...
	bool CanConnect_ForBlueprint(const struct FRigConnectionInfo& InConnectionInfo) const;
	...
	TArray<struct FRigConnectorInfo> GetConnectorInfos() const;
...
// 0x0560 (0x0A10 - 0x04B0)
class UControlRig : public URigVMHost
{
public:
	uint8                                         Pad_4B0[0x8];                                      // 0x04B0(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	ERigExecutionType                             ExecutionType;                                     // 0x04B8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4B9[0x3];                                      // 0x04B9(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	struct FRigHierarchySettings                  HierarchySettings;                                 // 0x04BC(0x0004)(NoDestructor, NativeAccessSpecifierPublic)
	TMap<struct FRigElementKey, struct FRigControlElementCustomization> ControlCustomizations;       // 0x04C0(0x0050)(Protected, NativeAccessSpecifierProtected)
	class URigHierarchy*                          DynamicHierarchy;                                  // 0x0510(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<TSoftObjectPtr<class UControlRigShapeLibrary>> ShapeLibraries;                            // 0x0518(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FString, class FString>            ShapeLibraryNameMap;                               // 0x0528(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_578[0x18];                                     // 0x0578(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
	class UAnimationDataSourceRegistry*           DataSourceRegistry;                                // 0x0590(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_598[0x90];                                     // 0x0598(0x0090)(Fixing Size After Last Property [ Dumper-8 ])
	struct FRigInfluenceMapPerEvent               Influences;                                        // 0x0628(0x0060)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_688[0xB8];                                     // 0x0688(0x00B8)(Fixing Size After Last Property [ Dumper-8 ])
	TMap<class FName, class UDataAssetLink*>      ExternalVariableDataAssetLinks;                    // 0x0740(0x0050)(ExportObject, Transient, DuplicateTransient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_790[0xD0];                                     // 0x0790(0x00D0)(Fixing Size After Last Property [ Dumper-8 ])
	FMulticastSparseDelegateProperty_             OnControlSelected_BP;                              // 0x0860(0x0001)(InstancedReference, BlueprintAssignable, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_861[0x17];                                     // 0x0861(0x0017)(Fixing Size After Last Property [ Dumper-8 ])
	bool                                          bIsAdditive;                                       // 0x0878(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_879[0x13F];                                    // 0x0879(0x013F)(Fixing Size After Last Property [ Dumper-8 ])
	struct FRigModuleSettings                     RigModuleSettings;                                 // 0x09B8(0x0048)(NativeAccessSpecifierPrivate)
	class FString                                 RigModuleNameSpace;                                // 0x0A00(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreInitializeDelegate;   // 0x0580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostInitializeDelegate;  // 0x0590(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreConstructionDelegate; // 0x05A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostConstructionDelegate; // 0x05B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreForwardsSolveDelegate; // 0x05C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostForwardsSolveDelegate; // 0x05D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_620[0xC0];                                     // 0x0620(0x00C0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TArray<bool>                                  IsControlActive;                                   // 0x0A10(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	EControlRigFKRigExecuteMode                   ApplyMode;                                         // 0x0A20(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A21[0x2F];                                     // 0x0A21(0x002F)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	struct FRigElementKey AddConnector(class FName InName, const struct FTransform& InTransform, bool bTransformInGlobal, const struct FRigConnectorSettings& InSettings, bool bSetupUndo, bool bPrintPythonCommand);
