...
namespace Offsets
{
	constexpr int32 GObjects          = 0x10AC4F80;
	constexpr int32 AppendString      = 0x00E6FB80;
	constexpr int32 GNames            = 0x10CD61C0;
	constexpr int32 GWorld            = 0x10AEC0B8;
	constexpr int32 ProcessEvent      = 0x038ED014;
	constexpr int32 ProcessEventIdx   = 0x0000004D;
    constexpr int32 Free              = 0x00000000;
    constexpr int32 Realloc           = 0x0400828C;
}
