...
public:
	...
	EBackgroundIntensityLevel                     K2Node_Event_IntensityTransition;                  // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	const class UTexture2D*                       K2Node_Event_LoadedBackgroundTexture;              // 0x0020(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FVaultWorldBackgroundData              K2Node_Event_BackgroundInfo_1;                     // 0x0028(0x0058)(ConstParm)
	const class UMaterialInterface*               K2Node_Event_LoadedBackgroundMaterial;             // 0x0080(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FVaultWorldBackgroundData              K2Node_Event_BackgroundInfo;                       // 0x0088(0x0058)(ConstParm)
	bool                                          K2Node_Event_bShowFloor;                           // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bShowEffects;                         // 0x00E1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_E2[0x6];                                       // 0x00E2(0x0006)(Fixing Size After Last Property [ Dumper-8 ])
	double                                        CallFunc_TransitionBackgroundForward_FXTransitionFade_ImplicitCast; // 0x00E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_TransitionBackgroundForward_FXTransitionFade_ImplicitCast_1; // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_TransitionBackgroundForward_Forward_ImplicitCast; // 0x00F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_TransitionBackgroundForward_Forward_ImplicitCast_1; // 0x0100(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
