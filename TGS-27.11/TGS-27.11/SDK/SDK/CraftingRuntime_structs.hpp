...
public:
	...
	struct FFortItemEntry                         PendingPickupCraftingItemEntry;                    // 0x0018(0x01A8)(NativeAccessSpecifierPublic)
	int32                                         PendingPickupHeldCount;                            // 0x01C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C4[0x4];                                      // 0x01C4(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<struct FFortItemEntry>                 AllOfTheIngredientItems;                           // 0x01C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 NonConsumedIngredientItemIndices;                  // 0x01D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FItemAndCount>                  CraftingResults;                                   // 0x01E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FGameplayAbilitySpecHandle             InstigatorWhileCraftingAbilitySpecHandle;          // 0x01F8(0x0004)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
