...
public:
	...
	class UObject*                                EquippedItemDefinitionObject;                      // 0x0008(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FCosmeticCustomizationInfo>     CustomizationInfo;                                 // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
