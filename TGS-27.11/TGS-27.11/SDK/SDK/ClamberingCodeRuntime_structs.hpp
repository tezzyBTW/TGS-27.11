...
{
public:
	uint8                                         Pad_C8[0xB8];                                      // 0x00C8(0x00B8)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	struct FSynchedActionWarpPointInfo_Replicated LedgeLaunchWarpPointInfo;                          // 0x0130(0x00A0)(NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bCanStandOnLedge;                                  // 0x01D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasFixedLedgeLaunchWarpPoint;                     // 0x01D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FScalableFloat                         MaxDirectionalLedgeLaunchAngle;                    // 0x0210(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         PBWLedgeLaunchMaxHorizontalTranslation;            // 0x0238(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         DefaultLedgeLaunchVerticalTranslation;             // 0x0260(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         PBWLedgeLaunchVerticalTranslation;                 // 0x0288(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         PBWNextLedgeLaunchVerticalTranslation;             // 0x02B0(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FScalableFloat                         FutureLedgeLaunchMaxVerticalDetectionRange;        // 0x0378(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         FutureLedgeLaunchMaxHorizontalDetectionRange;      // 0x03A0(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	bool                                          bHasNextLedgeLaunchTarget;                         // 0x00CC(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CD[0x3];                                       // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	struct FVector                                NextLedgeLaunchWarpPoint;                          // 0x00D0(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
