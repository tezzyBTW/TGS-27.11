...
// Parameters:
// bool                                    bEnableBackfill                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFortAthenaMutator_SpecialEvent::ForceSetMatchmakingBackfill(bool bEnableBackfill)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_SpecialEvent", "ForceSetMatchmakingBackfill");

	Params::FortAthenaMutator_SpecialEvent_ForceSetMatchmakingBackfill Parms{};

	Parms.bEnableBackfill = bEnableBackfill;
...
bool AFortAthenaMutator_SpecialEvent::ShouldPreventLeavingWarmup() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortAthenaMutator_SpecialEvent", "ShouldPreventLeavingWarmup");

	Params::FortAthenaMutator_SpecialEvent_ShouldPreventLeavingWarmup Parms{};
