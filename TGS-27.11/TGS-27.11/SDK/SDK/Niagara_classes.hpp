...
public:
	...
	uint8                                         Pad_445[0xBB];                                     // 0x0445(0x00BB)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_66C[0x34];                                     // 0x066C(0x0034)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_6A8[0x1];                                      // 0x06A8(0x0001)(Fixing Size After Last Property [ Dumper-8 ])
	...
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x06B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	class FName                                   AutoAttachSocketName;                              // 0x06C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x06CC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x06CD(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x06CE(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6CF[0x9];                                      // 0x06CF(0x0009)(Fixing Size After Last Property [ Dumper-8 ])
	uint8                                         BitPad_6D8_0 : 4;                                  // 0x06D8(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-8 ])
	uint8                                         bAllowScalability : 1;                             // 0x06D8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_6D9[0xEF];                                     // 0x06D9(0x00EF)(Fixing Size After Last Property [ Dumper-8 ])
