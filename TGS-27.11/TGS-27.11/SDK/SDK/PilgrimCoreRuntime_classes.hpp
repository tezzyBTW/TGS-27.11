...
// Class PilgrimCoreRuntime.AsyncAction_DelayUntilMidiEventBase
// 0x0020 (0x0050 - 0x0030)
class UAsyncAction_DelayUntilMidiEventBase : public UBlueprintAsyncActionBase
{
public:
...
public:
	...
	{
		return StaticClassImpl<"AsyncAction_DelayUntilMidiEventBase">();
	}
	static class UAsyncAction_DelayUntilMidiEventBase* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAsyncAction_DelayUntilMidiEventBase>();
	}
};

// Class PilgrimCoreRuntime.AsyncAction_DelayUntilMidiNoteEvent
// 0x0030 (0x0080 - 0x0050)
class UAsyncAction_DelayUntilMidiNoteEvent final : public UAsyncAction_DelayUntilMidiEventBase
{
public:
	TMulticastInlineDelegate<void(const int32 MidiEventNote, const struct FPilgrimEvent_Midi_NoteBase& MidiEventData)> OnMidiEventStart; // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const int32 MidiEventNote, const struct FPilgrimEvent_Midi_NoteBase& MidiEventData)> OnMidiEventEnd; // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_70[0x10];                                      // 0x0070(0x0010)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	static class UAsyncAction_DelayUntilMidiNoteEvent* DelayUntilMidiNoteEvent(class UPilgrimGame* PilgrimGame, const EPilgrimTrackType TrackType, const int32 EventNote, const float SecondsBeforeEventStart, const float SecondsBeforeEventEnd);
	static class UAsyncAction_DelayUntilMidiNoteEvent* DelayUntilMidiNoteEvents(class UPilgrimGame* PilgrimGame, const EPilgrimTrackType TrackType, const TArray<int32>& EventNotes, const float SecondsBeforeEventStart, const float SecondsBeforeEventEnd);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AsyncAction_DelayUntilMidiNoteEvent">();
	}
	static class UAsyncAction_DelayUntilMidiNoteEvent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAsyncAction_DelayUntilMidiNoteEvent>();
	}
};

// Class PilgrimCoreRuntime.AsyncAction_DelayUntilMidiTextEvent
// 0x0020 (0x0070 - 0x0050)
class UAsyncAction_DelayUntilMidiTextEvent final : public UAsyncAction_DelayUntilMidiEventBase
{
public:
	TMulticastInlineDelegate<void(const class FString& MidiEventText, const struct FPilgrimEvent_Midi_TextBase& MidiEventData)> OnMidiEventStart; // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0x10];                                      // 0x0060(0x0010)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	static class UAsyncAction_DelayUntilMidiTextEvent* DelayUntilMidiTextEvent(class UPilgrimGame* PilgrimGame, const EPilgrimTrackType TrackType, const class FString& EventString, const float SecondsBeforeEventStart);
	static class UAsyncAction_DelayUntilMidiTextEvent* DelayUntilMidiTextEvents(class UPilgrimGame* PilgrimGame, const EPilgrimTrackType TrackType, const TArray<class FString>& EventStrings, const float SecondsBeforeEventStart);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AsyncAction_DelayUntilMidiTextEvent">();
	}
	static class UAsyncAction_DelayUntilMidiTextEvent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAsyncAction_DelayUntilMidiTextEvent>();
	}
};

// Class PilgrimCoreRuntime.AsyncAction_DelayUntilMidiStrikeEvent
// 0x0020 (0x0070 - 0x0050)
class UAsyncAction_DelayUntilMidiStrikeEvent final : public UAsyncAction_DelayUntilMidiEventBase
{
public:
	TMulticastInlineDelegate<void(const struct FPilgrimEvent_Midi_StrikeBase& MidiEventData)> OnMidiEventStart; // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FPilgrimEvent_Midi_StrikeBase& MidiEventData)> OnMidiEventEnd; // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	static class UAsyncAction_DelayUntilMidiStrikeEvent* DelayUntilMidiStrikeEvent(class UPilgrimGame* PilgrimGame, const EPilgrimTrackType TrackType, const float SecondsBeforeEventStart, const float SecondsBeforeEventEnd);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AsyncAction_DelayUntilMidiStrikeEvent">();
	}
	static class UAsyncAction_DelayUntilMidiStrikeEvent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAsyncAction_DelayUntilMidiStrikeEvent>();
	}
};

// Class PilgrimCoreRuntime.AsyncAction_ListenForMidiNotePools
// 0x0048 (0x0098 - 0x0050)
class UAsyncAction_ListenForMidiNotePools final : public UAsyncAction_DelayUntilMidiEventBase
{
public:
	TMulticastInlineDelegate<void(const int32 MidiNote, const struct FPilgrimEvent_Midi_NoteBase& MidiNoteData, const class FName WaitPoolID, const float ActualDelay, const float MaxDelayShortenedBy)> OnMidiNoteStart; // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<int32>                                 EventNotes;                                        // 0x0060(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<int32>                                 WatchNotes;                                        // 0x0070(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<struct FMidiNoteEventDelayPool>        DelayPools;                                        // 0x0080(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	float                                         LongestDelay;                                      // 0x0090(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LastEventIndexFired;                               // 0x0094(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	static class UAsyncAction_ListenForMidiNotePools* ListenForMidiNotePoolsEvent(class UPilgrimGame* InPilgrimGame, const EPilgrimTrackType InTrackType, const int32 InEventNote, const TArray<int32>& InWatchNotes, const TArray<struct FMidiNoteEventDelayPool>& InDelayPools);
	static class UAsyncAction_ListenForMidiNotePools* ListenForMidiNotePoolsEvents(class UPilgrimGame* InPilgrimGame, const EPilgrimTrackType InTrackType, const TArray<int32>& InEventNotes, const TArray<int32>& InWatchNotes, const TArray<struct FMidiNoteEventDelayPool>& InDelayPools);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AsyncAction_ListenForMidiNotePools">();
	}
	static class UAsyncAction_ListenForMidiNotePools* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAsyncAction_ListenForMidiNotePools>();
	}
};
...
public:
	...
	uint8                                         Pad_B8[0x70];                                      // 0x00B8(0x0070)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_50[0xC0];                                      // 0x0050(0x00C0)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_50[0x238];                                     // 0x0050(0x0238)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
class UPilgrimCorePlayerStateComponent : public UPlayerStateComponent
{
public:
	EPilgrimSongDifficulty                        SongDifficulty;                                    // 0x00A0(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EPilgrimTrackType                             InstrumentChoice;                                  // 0x00A1(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsReady;                                          // 0x00A2(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsUsingPlastic;                                   // 0x00A3(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bPregameChoicesLocked;                             // 0x00A4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
class UPilgrimDanceSynchronizerComponent final : public UMontageBeatSyncComponent
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	uint8                                         Pad_1D0[0x330];                                    // 0x01D0(0x0330)(Fixing Size After Last Property [ Dumper-8 ])
	class UPilgrimSongData*                       SongData;                                          // 0x0500(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_508[0x18];                                     // 0x0508(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
	class UPilgrimMidiEventRouter*                MidiEventRouter;                                   // 0x0520(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_528[0x10];                                     // 0x0528(0x0010)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	void AddScoreMod(EPilgrimScoringTarget Target, class UPilgrimScoringModifier* ScoringModifier);
	void AddTrack(class APilgrimTrack* Track);
	void ApplyRawScoreModifier(float Score);
	void ApplySettingsFromConfig(const class UPilgrimGameConfig* GameConfig, const TArray<struct FPilgrimScoreMultiplierInfo>& ScoreMultiplierDefinitions);
	void CheatEndSong();
	...
	void RemoveScoreMod(EPilgrimScoringTarget Target, class UPilgrimScoringModifier* ScoringModifier);
	...
	bool IsUseAlternativeTouchLayoutEnabled() const;
...
public:
	...
	struct FPilgrimGameConfigSettings             ConfigSettings;                                    // 0x0040(0x0298)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class USoundBase*                             MissSound;                                         // 0x02D8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxHp;                                             // 0x02E0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DamagePerHit;                                      // 0x02E4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<EFortRarity, float>                      WeaponRarityToNoteDamage;                          // 0x02E8(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<struct FPilgrimStreakInfo>             StreakDefinitions;                                 // 0x0338(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FPilgrimScoreMultiplierInfo>    ScoreMultiplierDefinitions;                        // 0x0030(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          HidePilgrimGameplayUI;                             // 0x0040(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          HidePilgrimTrackAndGems;                           // 0x0041(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_58[0x190];                                     // 0x0058(0x0190)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	float                                         TrackSpeedMultiplier;                              // 0x0028(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TrackBackgroundOpacity;                            // 0x002C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GameplayMusicVolume;                               // 0x0030(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TMap<struct FPilgrimDifficultyTrackTypePair, struct FPilgrimGemDensityDataArray> SongSectionGemDensityDataMap; // 0x00D0(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FPilgrimDifficultyTrackTypePair, struct FPilgrimGemDensityDataArray> GameplaySectionGemDensityDataMap; // 0x0120(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_170[0x50];                                     // 0x0170(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
	struct FScalableFloat                         MinimumEmptyBarsForBreak;                          // 0x01C0(0x0028)(Edit, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                         Pad_A0[0x3F8];                                     // 0x00A0(0x03F8)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_B0[0xE8];                                      // 0x00B0(0x00E8)(Fixing Size After Last Property [ Dumper-8 ])
	float                                         FriendPopupTimeSeconds;                            // 0x0198(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_19C[0x14];                                     // 0x019C(0x0014)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	void OnMidiDataDownloaded(const class UObject* CatalogData);
...
public:
	...
	class UPilgrimSongMetadata*                   SongToPlay;                                        // 0x02F0(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPilgrimSongDifficulty                        SongDifficultyToPlay;                              // 0x02F8(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bClientHasReceivedSongToPlay;                      // 0x02F9(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2FA[0x6];                                      // 0x02FA(0x0006)(Fixing Size After Last Property [ Dumper-8 ])
	struct FPilgrimSinglePlayerBattleData         SinglePlayerBattleData;                            // 0x0300(0x0010)(BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	int32                                         LocalPlayerIndex;                                  // 0x0310(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_314[0x4];                                      // 0x0314(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class AFortPlayerStateAthena*>         MusicBattlePlayers;                                // 0x0318(0x0010)(Edit, BlueprintVisible, Net, ZeroConstructor, Protected, ExposeOnSpawn, NativeAccessSpecifierProtected)
	struct FMusicBattleSinglePlayerOptions        SinglePlayerBattleOptions;                         // 0x0328(0x0008)(Edit, BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	class UPilgrimGameConfig*                     PilgrimGameConfig;                                 // 0x0330(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EMusicBattleType                              MusicBattleType;                                   // 0x0338(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_339[0x7];                                      // 0x0339(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UAudioComponent*                        LocalMetasoundPlayer;                              // 0x0340(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAudioComponent*                        LocalMetasoundMixer;                               // 0x0348(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_350[0x68];                                     // 0x0350(0x0068)(Fixing Size After Last Property [ Dumper-8 ])
	class UHarmonixAudioAnalyzerResultsProvider*  FFTAnalyzerResultsProvider;                        // 0x03B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<class UPilgrimPlayerControllerComponent*, int32> CurrentPlayerToIndexMap;                   // 0x03C0(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	class UPilgrimSongData*                       SongData;                                          // 0x0410(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_418[0x50];                                     // 0x0418(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
	TMap<class AFortPlayerStateAthena*, class UServerPilgrimGame*> ServerPilgrimGameMap;             // 0x0468(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4B8[0x1A8];                                    // 0x04B8(0x01A8)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UPilgrimGemBreakListener*>       GemBreakListeners;                                 // 0x0660(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_670[0xF8];                                     // 0x0670(0x00F8)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	void ServerOnPilgrimScoreChanged(class UPilgrimPlayerControllerComponent* PlayerControllerComponent, const struct FPilgrimGameProgress& NextScoreForCurrentPlayer);
	void ServerOnSongMidiFinishedLoading();
	void ServerOnTeamQuickplayScoreChanged(class UPilgrimPlayerControllerComponent* PlayerControllerComponent, const struct FPilgrimGameProgress& NextScoreForCurrentPlayer);
	...
	const TArray<struct FPilgrimScoreMultiplierInfo> GetMultiplierInfoForPlayer(const class AFortPlayerStateAthena* Player) const;
...
public:
	...
	TMulticastInlineDelegate<void(class AFortPlayerController* FortPlayerController, class UFortInputMappingContext* InputMappingContext)> OnActivateInputPreset; // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AFortPlayerController* FortPlayerController, class UFortInputMappingContext* InputMappingContext)> OnDesiredInputPresetChanged; // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnInputSettingsChanged;                            // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UPilgrimPlayerControllerComponent* PlayerControllerComponent, EMusicBattleClientUpdate MusicBattleUpdate)> OnMusicBattleClientUpdateReceived; // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UDataTable*                             DefaultUnbindsDataTable;                           // 0x00F0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UInputAction*                           CycleInputsInputAction;                            // 0x00F8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_100[0x8];                                      // 0x0100(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	class UInputAction*                           CycleLanesInputAction;                             // 0x0108(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_110[0x8];                                      // 0x0110(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	class UInputAction*                           EmotePickerInputAction;                            // 0x0118(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortInputMappingContext*               GlobalInputMappingContext;                         // 0x0120(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortInputMappingContext*               CheatMappingContext;                               // 0x0128(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TMap<uint8, struct FPilgrimLaneInputMappingConfig> LaneInputMappingConfigs;                      // 0x0130(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	struct FPilgrimTouchBrushesMappingConfig      TouchBrushesConfig;                                // 0x0180(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	uint8                                         SelectedNumInputLanes;                             // 0x0190(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_191[0x7];                                      // 0x0191(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UFortInputMappingContext*               SelectedPCBeatmatchIMC;                            // 0x0198(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortInputMappingContext*               SelectedConsoleBeatmatchIMC;                       // 0x01A0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1A8[0x50];                                     // 0x01A8(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
	class UPilgrimGameUserSettings*               PilgrimGameUserSettings;                           // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	void SetDesiredInputMappingContext(class UFortInputMappingContext* NewContext, bool bShouldUpdateSettings);
...
{
public:
	TArray<class APilgrimMusicBattleInstance*>    PilgrimMusicBattleInstances;                       // 0x0720(0x0010)(Net, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UNetworkedMusicClockManager*            MusicClockManager;                                 // 0x0730(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPilgrimPlayspaceComponent_SongPreloader* SongPreloader;                                   // 0x0738(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPilgrimMediaStreamer*                  MediaStreamer;                                     // 0x0740(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPilgrimGemAnalyzer*                    GemAnalyzer;                                       // 0x0748(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPilgrimPlayspaceComponent_LipSyncAssetManager* LipSyncManager;                            // 0x0750(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPilgrimGameConfig*                     PilgrimGameConfig;                                 // 0x0758(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
// 0x0008 (0x00A8 - 0x00A0)
class UPilgrimRenderTargetComponent final : public UControllerComponent
{
public:
...
public:
	...
	struct FPilgrimGameProgress                   GameProgress;                                      // 0x0030(0x0068)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FPilgrimGameConfigSettings             GameConfigSettings;                                // 0x0098(0x0298)(NativeAccessSpecifierPublic)
	uint8                                         Pad_330[0x18];                                     // 0x0330(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
	TWeakObjectPtr<class AActor>                  ContextActor;                                      // 0x0348(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_350[0xA0];                                     // 0x0350(0x00A0)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	float ComputeMaxScore(const TArray<struct FTrackItemInfo>& Gems);
	...
	float ComputeSustainScorePerSecond(EPilgrimScoringMode ScoringMode) const;
...
public:
	...
	struct FPilgrimSongPlaylistEntry GetPlaylistEntryFromItem(const class UFortItemDefinition* SongItem) const;
	...
	class UPilgrimSongMetadata* GetSongFromItem(const class UFortItemDefinition* SongItem) const;
...
public:
	...
	TMap<EPilgrimSongDifficulty, int32>           NumLanesPerDifficulty;                             // 0x0170(0x0050)(NativeAccessSpecifierPrivate)
	TArray<struct FTrackItemInfo>                 BeatMarkers;                                       // 0x01C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	class FText                                   Title;                                             // 0x0038(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FText                                   Artist;                                            // 0x0050(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  AdditionalTags;                                    // 0x0068(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	int32                                         Year;                                              // 0x0088(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	TMap<EPilgrimTrackType, int32>                IntensityPerInstrument;                            // 0x0090(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UTexture2D>              AlbumArt;                                          // 0x00E0(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UObject*                                SparksCatalogData;                                 // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsGDriveSong;                                     // 0x0140(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_141[0x7];                                      // 0x0141(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	TSoftObjectPtr<class UStemmedMusicAsset>      StemmedMusicAsset;                                 // 0x0148(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimSequence>           LipSyncAnimAsset;                                  // 0x0168(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UStemmedMusicAsset>      StemmedMusicAssetRuntime;                          // 0x0188(0x0020)(Transient, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UAnimSequence>           LipSyncAnimAssetRuntime;                           // 0x01A8(0x0020)(Transient, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_132[0x26];                                     // 0x0132(0x0026)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	class AActor*                                 ViewOwner;                                         // 0x0B50(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
// Class PilgrimCoreRuntime.PilgrimTrackDisplay
// 0x0048 (0x02D8 - 0x0290)
class APilgrimTrackDisplay final : public AActor
{
public:
	uint8                                         Pad_290[0x8];                                      // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<struct FStaticMaterial>                StaticMaterials;                                   // 0x0298(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bInDisplayTrack)> OnDisplayTrackChanged;                      // 0x02A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UStaticMeshComponent*                   TrackDisplayMesh;                                  // 0x02B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C0[0x10];                                     // 0x02C0(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	bool                                          bDisplayTrack;                                     // 0x02D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2D1[0x7];                                      // 0x02D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	void SafeFrameChanged(const struct FIntPoint& FrameSize);
	void SetDisplayTrack(bool bInDisplayTrack);
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PilgrimTrackDisplay">();
	}
	static class APilgrimTrackDisplay* GetDefaultObj()
	{
		return GetDefaultObjImpl<APilgrimTrackDisplay>();
	}
};
