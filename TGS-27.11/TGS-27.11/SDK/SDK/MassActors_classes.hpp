...
class UMassActorSpawnerSubsystem final : public UWorldSubsystem
{
public:
	TArray<struct FInstancedStruct>               SpawnRequests;                                     // 0x0030(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	class UMassSpawnerSubsystem*                  SpawnerSystem;                                     // 0x0040(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMassSimulationSubsystem*               SimulationSystem;                                  // 0x0048(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TMap<struct FMassEntityTemplateID, struct FMassAgentInitializationQueue> PendingAgentEntities;   // 0x0050(0x0050)(ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TMap<struct FMassEntityTemplateID, struct FMassAgentInitializationQueue> PendingPuppets;         // 0x00A0(0x0050)(ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class UMassReplicationSubsystem*              ReplicationSubsystem;                              // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TMap<struct FMassNetworkID, class UMassAgentComponent*> ReplicatedAgentComponents;               // 0x00F8(0x0050)(ExportObject, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_148[0x30];                                     // 0x0148(0x0030)(Fixing Struct Size After Last Property [ Dumper-8 ])
