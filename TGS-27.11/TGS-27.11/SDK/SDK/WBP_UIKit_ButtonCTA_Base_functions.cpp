...
void UWBP_UIKit_ButtonCTA_Base_C::TryAddBackground()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "TryAddBackground");
...
void UWBP_UIKit_ButtonCTA_Base_C::UnregisterBlocks()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "UnregisterBlocks");
