...
public:
	...
	const class UFortAnimInputEvent*              K2Node_Event_AnimInputEvent;                       // 0x0140(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortAnimInputEvent_Bool*               K2Node_DynamicCast_AsFort_Anim_Input_Event_Bool;   // 0x0148(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsNamed_ReturnValue_1;                    // 0x0152(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortPlayerAnimationInterface*          CallFunc_GetAnimationInterface_ReturnValue;        // 0x0158(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FInstancedStruct                       CallFunc_MakeLookupProxyWithOverrideTable_ReturnValue; // 0x0160(0x0010)()
	struct FInstancedStruct                       CallFunc_MakeLookupProxyWithOverrideTable_ReturnValue_1; // 0x0170(0x0010)()
	...
	float                                         CallFunc_GetCurveValue_ReturnValue;                // 0x0184(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetCurveValue_ReturnValue_1;              // 0x0198(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetCurveValue_ReturnValue_2;              // 0x019C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FChooserEvaluationContext              CallFunc_MakeChooserEvaluationContext_ReturnValue; // 0x01A0(0x0050)()
	class UAnimSequence*                          CallFunc_EvaluateObjectChooserBase_ReturnValue;    // 0x01F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FChooserEvaluationContext              CallFunc_MakeChooserEvaluationContext_ReturnValue_1; // 0x01F8(0x0050)()
	class UBlendSpace*                            CallFunc_EvaluateObjectChooserBase_ReturnValue_1;  // 0x0248(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
