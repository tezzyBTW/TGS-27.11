...
{
public:
	TArray<TSubclassOf<class UWidget>>            StylableWidgetClasses;                             // 0x0000(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPublic)
};
