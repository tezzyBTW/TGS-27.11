...
public:
	...
	uint32                                        VMHash;                                            // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	class URigVMMemoryStorage*                    WorkMemoryStorageObject;                           // 0x0010(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URigVMMemoryStorage*                    DebugMemoryStorageObject;                          // 0x0018(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMMemoryStorageStruct              WorkMemoryStorage;                                 // 0x0020(0x0050)(NativeAccessSpecifierPublic)
	struct FRigVMMemoryStorageStruct              DebugMemoryStorage;                                // 0x0070(0x0050)(NativeAccessSpecifierPublic)
	uint8                                         Pad_C0[0x180];                                     // 0x00C0(0x0180)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
