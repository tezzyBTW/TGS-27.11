...
void AB_Ranged_Generic_C::AddRandomScale_Paprika()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Ranged_Generic_C", "AddRandomScale_Paprika");
...
void AB_Ranged_Generic_C::MuzzleModCheck(bool* isMuzzleBrake, bool* isMuzzleSupressor)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UFXSystemComponent*>&      Muzzle_Systems                                         (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)

void AB_Ranged_Generic_C::TEMP_PaprikaADSSizeAdjustment(TArray<class UFXSystemComponent*>& Muzzle_Systems)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Ranged_Generic_C", "TEMP_PaprikaADSSizeAdjustment");

	Params::B_Ranged_Generic_C_TEMP_PaprikaADSSizeAdjustment Parms{};

	Parms.Muzzle_Systems = std::move(Muzzle_Systems);

	UObject::ProcessEvent(Func, &Parms);

	Muzzle_Systems = std::move(Parms.Muzzle_Systems);
}
