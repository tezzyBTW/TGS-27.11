...
public:
	...
	uint8                                         Pad_339[0x7];                                      // 0x0339(0x0007)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
{
public:
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x0000(0x0250)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	const class UPCGMetadata*                     MetaData;                                          // 0x0250(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           AttributeNames;                                    // 0x0258(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x0268(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x00B8(0x0250)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x0308(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_32[0xE];                                       // 0x0032(0x000E)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
