...
// Function TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.PushCustomMovementModeExtensionClass
// 0x0008 (0x0008 - 0x0000)
struct FortPlayerControllerComponent_TacticalSprint_PushCustomMovementModeExtensionClass final
{
public:
	TSubclassOf<class UFortMovementMode_ELTacSprint> NewCustomMMExtensionClass;                      // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
