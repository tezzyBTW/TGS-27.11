...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TArray<struct FRigConnectorInfo>& InInfos                                                (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
TArray<struct FRigElementKey> URigHierarchy::RestoreConnectorsFromInfos(const TArray<struct FRigConnectorInfo>& InInfos, bool bSetupUndoRedo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchy", "RestoreConnectorsFromInfos");

	Params::RigHierarchy_RestoreConnectorsFromInfos Parms{};

	Parms.InInfos = std::move(InInfos);
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const struct FRigConnectionInfo&        InConnectionInfo                                       (Parm, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool URigHierarchy::CanConnect_ForBlueprint(const struct FRigConnectionInfo& InConnectionInfo) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchy", "CanConnect_ForBlueprint");

	Params::RigHierarchy_CanConnect_ForBlueprint Parms{};

	Parms.InConnectionInfo = std::move(InConnectionInfo);
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// TArray<struct FRigConnectorInfo>        ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)

TArray<struct FRigConnectorInfo> URigHierarchy::GetConnectorInfos() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchy", "GetConnectorInfos");

	Params::RigHierarchy_GetConnectorInfos Parms{};
...
struct FRigElementKey URigHierarchyController::AddConnector(class FName InName, const struct FTransform& InTransform, bool bTransformInGlobal, const struct FRigConnectorSettings& InSettings, bool bSetupUndo, bool bPrintPythonCommand)
{
	static class UFunction* Func = nullptr;
