...
class UTexture* UMovieGraphRendererBase::GetPreviewTexture() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieGraphRendererBase", "GetPreviewTexture");

	Params::MovieGraphRendererBase_GetPreviewTexture Parms{};
...
struct FMovieGraphTraversalContext UMovieGraphPipeline::GetCurrentTraversalContext() const
{
	static class UFunction* Func = nullptr;
...
bool UMoviePipelineCollectionLightingQuery::DoesActorMatchQuery(const class AActor* Actor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MoviePipelineCollectionLightingQuery", "DoesActorMatchQuery");

	Params::MoviePipelineCollectionLightingQuery_DoesActorMatchQuery Parms{};
...
void UMoviePipelineRenderLayer::SetRenderLayerName(const class FName& NewName)
{
	static class UFunction* Func = nullptr;
...
class FName UMoviePipelineRenderLayer::GetRenderLayerName() const
{
	static class UFunction* Func = nullptr;
...
void UMoviePipelineRenderLayerSubsystem::SetActiveRenderLayerByName(const class FName& RenderLayerName)
{
	static class UFunction* Func = nullptr;
