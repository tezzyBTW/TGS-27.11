...
public:
	...
	TMulticastInlineDelegate<void(const struct FMcpVariantChannelInfo& InChannelInfo)> OnVariantEngagedEvent; // 0x0430(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	uint8                                         Pad_440[0x68];                                     // 0x0440(0x0068)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	TWeakObjectPtr<class UAthenaCosmeticItemDefinition> ItemDefinition;                              // 0x07E8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortCustomizableObjectSprayVariant*    SprayVariant;                                      // 0x07F0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7F8[0x98];                                     // 0x07F8(0x0098)(Fixing Struct Size After Last Property [ Dumper-8 ])
