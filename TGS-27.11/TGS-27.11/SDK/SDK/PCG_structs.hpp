...
{
public:
	uint8                                         Pad_B0[0x1F8];                                     // 0x00B0(0x01F8)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
{
public:
	struct FSoftISMComponentDescriptor            Descriptor;                                        // 0x0000(0x0230)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     Instances;                                         // 0x0230(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int64>                                 InstancesMetadataEntry;                            // 0x0240(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
