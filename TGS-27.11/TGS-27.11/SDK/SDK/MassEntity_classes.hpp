...
{
public:
	struct FMassRuntimePipeline                   ChildPipeline;                                     // 0x00C0(0x0010)(Edit, EditConst, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   GroupName;                                         // 0x00D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_D4[0x24];                                      // 0x00D4(0x0024)(Fixing Struct Size After Last Property [ Dumper-8 ])
