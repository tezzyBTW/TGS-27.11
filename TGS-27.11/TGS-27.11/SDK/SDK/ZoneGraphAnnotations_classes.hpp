...
{
public:
	uint8                                         Pad_5C8[0x18];                                     // 0x05C8(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	struct FZoneGraphTag                          DangerAnnotationTag;                               // 0x05E8(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FZoneGraphTag                          ObstacleAnnotationTag;                             // 0x05E9(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5EA[0x2];                                      // 0x05EA(0x0002)(Fixing Size After Last Property [ Dumper-8 ])
	struct FZoneGraphTagFilter                    AffectedLaneTags;                                  // 0x05EC(0x000C)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FZoneGraphTagFilter                    EscapeLaneTags;                                    // 0x05F8(0x000C)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         IdealSpanLength;                                   // 0x0604(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_608[0x40];                                     // 0x0608(0x0040)(Fixing Size After Last Property [ Dumper-8 ])
